...
/Users/chenjiang/bin/spark-2.3.1-bin-hadoop2.7/bin/spark-submit --executor-cores 1 --master $MASTER --jars $LIB --class org.apache.spark.sql.execution.datasources.hbase.HGraphDBSource $MLJar $ZK $GRAPH "$@" 
